    ...
    <div className='App fixed w-full h-full bg-slate-100 dark:bg-slate-900'>
      <header className='header absolute flex items-center justify-center top-2 start-2 right-2 h-16'>
        <div className='header-left h-full gap-2 flex items-center justify-center'>
          <Button type='text' text='h' title="Abrir pestaña Himnario" ariaLabel="Abrir pestaña Himnario" className='h-8 w-8 rounded-full text-black dark:text-white bg-white hover:bg-slate-200 active:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:active:bg-slate-600 transition-colors' />
          <Button type='text' text='b' title="Abrir pestaña Santa Bilia" ariaLabel="Abrir pestaña Santa Bilia" className='h-8 w-8 rounded-full text-black dark:text-white bg-white hover:bg-slate-200 active:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:active:bg-slate-600 transition-colors' />
        </div>
        ...
        <div className='header-right h-full items-center justify-center flex items-center justify-center top-2 start-2 right-2 h-16'>
          <Button type='text' text='s' title="Configuración" ariaLabel="Configuración" className='h-8 w-8 text-black dark:text-white bg-white rounded-full hover:bg-slate-200 active:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:active:bg-slate-600 transition-colors' />
        </div>
      </header>
